...
<body id="page-top">
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel c/test2.jpg" alt="">
	</div>
	<br>
	<!-- ตาราง เหล็กตัวซี -->
	<div class="container">
		<div class="datagrid">
			<h4 class="text-center">ตารางเหล็กตัวซี มาตรฐานเหล็กตัวซี</h4>
			<br>
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>0002903028</td>
						<td>ตัวซี #3 ฟ้า-เขียว(75X45X15X1.6)มอก.(11.4)</td>
						<td><span id="price-0002903028">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0002903030</td>
						<td>ตัวซี #3 ส้ม(75X45X15X2.0)มอก.(15.7)</td>
						<td><span id="price-0002903030">xxx</span></td>
					</tr>

					<tr>
						<td>0002903032</td>
						<td>ตัวซี 3 น้ำเงิน (75x45x15)2.3 มอก(18+/-)</td>
						<td><span id="price-0002903032">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0002904003</td>
						<td>ตัวซี #4 น้ำเงิน 3.2 มอก.(30+/-) (80/มัด)</td>
						<td><span id="price-0002904003">xxx</span></td>
					</tr>

					<tr>
						<td>0002904006</td>
						<td>ตัวซี #4 ทอง 2.3 มอก.(22+/-) (80/มัด)</td>
						<td><span id="price-0002904006">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0002904007</td>
						<td>ตัวซี #4 ทอง-เหลือง 2.3 มอก.(21.5+/-)</td>
						<td><span id="price-0002904007">xxx</span></td>
					</tr>

					<tr>
						<td>0002904040</td>
						<td>ตัวซี #4 ส้ม(100x50x20x2.0)มอก.(19.4)</td>
						<td><span id="price-0002904040">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0002905015</td>
						<td>ตัวซี 5 ทอง 2.3 มอก.(25+/-) (60/มัด)</td>
						<td><span id="price-0002905015">xxx</span></td>
					</tr>

					<tr>
						<td>0002905016</td>
						<td>ตัวซี 5 น้ำเงิน 3.2 มอก.(33.5) (60/มัด)</td>
						<td><span id="price-0002905016">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0002906002</td>
						<td>ตัวซี #6 ทอง 2.3 มม.มอก.(27+/-) (60/มัด)</td>
						<<td><span id="price-0002906002">xxx</span></td>
					</tr>

					<tr>
						<td>0002906006</td>
						<td>ตัวซี #6 น้ำเงิน 3.2 มม.มอก.(37+/-) </td>
						<td><span id="price-0002906006">xxx</span></td>
					</tr>
