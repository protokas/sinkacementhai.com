...
<body id="page-top">
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel cheakered plate/test1.jpg" alt="">
	</div>
	<br>
	<!-- ตาราง เหล็กแผ่นลาย -->
	<div class="container">
		<div class="datagrid">
			<h4 class="text-center">ตารางเหล็กแผ่นลาย มาตรฐานเหล็กแผ่นลาย</h4>
			<br>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>0005102600</td>
						<td>เหล็กแผ่นลาย (2.3มม.)ขาว (สห)</td>
						<td><span id="price-0005102600">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0005103002</td>
						<td>เหล็กแผ่นลาย (3มม.) สห แดง</td>
						<td><span id="price-0005103002">xxx</span></td>
					</tr>

					<tr>
						<td>0005104010</td>
						<td>เหล็กแผ่นลาย (4มม.)(สห) ฟ้า</td>
						<td><span id="price-0005104010">xxx</span></td>
					</tr>
