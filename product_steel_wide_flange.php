...
<body id="page-top">
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel wide flange/test1.jpg" alt="">
	</div>
	<br>
	<!-- ตาราง เหล็กไวด์แฟรค์ -->
	<div class="container">
		<div class="datagrid">
			<h4 class="text-center">ตารางเหล็กไวด์แฟรค์ มาตรฐานเหล็กไวด์แฟรค์</h4>
			<br>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>0003220000</td>
						<td>200 x 100 x 5.5 x 8 มม. x 6 ม.</td>
						<td>ยาว 6 เมตร</td>
						<td><span id="price-0003220000">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0003225000</td>
						<td>250 x 125 x 6.5 x 9 มม. x 6 ม.</td>
						<td>ยาว 6 เมตร</td>
						<td><span id="price-0003225000">xxx</span></td>
					</tr>

				<tbody>
					<tr>
						<td>0003230000</td>
						<td>300 x 150 x 6.5 x 9 มม. x 6 ม.</td>
						<td>ยาว 6 เมตร</td>
						<td><span id="price-0003230000">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0003240000</td>
						<td>400 x 200 x 8 x 13 มม. x 6 ม.</td>
						<td>ยาว 6 เมตร</td>
						<td><span id="price-0003240000">xxx</span></td>
					</tr>
