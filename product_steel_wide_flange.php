...
<body id="page-top">
    ...
    <div class="container">
        <h6 class="f700"> <a href="product.php" style="color:black;">สินค้าทั้งหมด</a>/<a href="product_st.php" style="color:black;">สินค้าเหล็ก</a>/<a style="color:gray;">เหล็กไวด์แฟรงค์ (Wide Flange)</a></h6>
    </div>
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class=" text-center">
                    <h4 class="br f700" style="color:white" >เหล็กไวด์แฟรงค์ (Wide Flange)</h4>
                </div>
                    ...
                    <div class="col-md-6">
                        <div id="myCarousel" class="carousel slide" data-ride="carousel" align="center">
                            <div class="carousel-inner">
                                <div class="carousel-item active"> <img src="img/steel/steel wide flange/test1.jpg" class="rounded"> </div>
                                <div class="carousel-item"> <img src="img/steel/steel wide flange/test2.jpg" class="rounded"> </div>
                            </div>
                            <ol class="carousel-indicators list-inline">
                                <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel"> <img src="img/steel/steel wide flange/test1.jpg" class="img-fluid rounded"> </a> </li>
                                <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel"> <img src="img/steel/steel wide flange/test2.jpg" class="img-fluid rounded"> </a> </li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        ...
                        <div id="collapse-238" class="collapse show" aria-labelledby="heading-238" data-parent="#accordion">
                            <div class="text-center kanit card-body accordion-body">
                                <p> 200 x 100 x 5.5 x 8 มม. x 6 ม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003220000">xxx</span></p>
								<p> 250 x 125 x 6.5 x 9 มม. x 6 ม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003225000">xxx</span></p>
								<p> 300 x 150 x 6.5 x 9 มม. x 6 ม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003230000">xxx</span></p>
								<p> 400 x 200 x 8 x 13 มม. x 6 ม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003240000">xxx</span></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        var uri = 'http://mv.co.th/WebApi/api/PriceList/GetPriceByGroupID/6';
