...
<body id="page-top">
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel white shaft/test2.jpg" alt="">
	</div>
	<br>
<!-- ตาราง เหล็กเพลาขาว -->
<div class="container">
	<div class="datagrid">
	<h4 class="text-center">ตารางเหล็กเพลาขาว มาตรฐานเหล็กเพลาขาว</h4>
			<br>
		...
		<table class="table table-bordered">
			...
			<tbody>
				<tr>
					<td>0003504000</td>
					<td>เพลาขาว 1/2</td>
					<td><span id="price-0003504000">xxx</span></td>
				</tr>

				<tr class="alt">
					<td>0003505000</td>
					<td>เพลาขาว 5/8</td>
					<td><span id="price-0003505000">xxx</span></td>
				</tr>

				<tr>
					<td>0003506000</td>
					<td>เพลาขาว 3/4</td>
					<td><span id="price-0003506000">xxx</span></td>
				</tr>

				<tr class="alt">
					<td>0003510000</td>
					<td>เพลาขาว 1"</td>
					<td><span id="price-0003510000">xxx</span></td>
				</tr>

				<tr>
					<td>0003512000</td>
					<td>เพลาขาว 1-1/4</td>
					<td><span id="price-0003512000">xxx</span></td>
				</tr>

				<tr class="alt">
					<td>0003514000</td>
					<td>เพลาขาว 1-1/2</td>
					<td><span id="price-0003514000">xxx</span></td>
				</tr>

				<tr>
					<td>0003516000</td>
					<td>เพลาขาว 1-3/4</td>
					<td><span id="price-0003516000">xxx</span></td>
				</tr>

				<tr class="alt">
					<td>0003524000</td>
					<td>เพลาขาว 2-1/2</td>
					<td><span id="price-0003524000">xxx</span></td>
				</tr>
