...
<body id="page-top">
  ...
  <div class="text-center container">
    ...
    <iframe id="JotFormIFrame-210548632319455" title="แบบฟอร์มกรอกใบสมัครงาน" onload="window.parent.scrollTo(0,0)" allowtransparency="true" allowfullscreen="true" allow="geolocation; microphone; camera" src="https://form.jotform.com/210548632319455" frameborder="0" style="
      min-width: 100%;
      height:539px;
      border:none;" scrolling="no">
    </iframe>
    <script type="text/javascript">
      var ifr = document.getElementById("JotFormIFrame-210548632319455");
      if (ifr) {
        var src = ifr.src;
        var iframeParams = [];
