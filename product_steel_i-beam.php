...
<body id="page-top">
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel i-beam/test1.jpg" alt="">
	</div>
	<br>
	<!-- ตาราง เหล็กไอบีม (i-BEAM) -->
	<div class="container">
		<div class="datagrid">
			<h4 class="text-center">ตารางเหล็กไอบีม มาตรฐานเหล็กไอบีม</h4>
			<br>
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>0003425000</td>
						<td>ไอบีม 250+125+7.5X12.5 มม.+6ม.(เหลือง)</td>
						<td><span id="price-0003425000">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0003425000</td>
						<td>ไอบีม 250+125+7.5X12.5 มม.+6ม.(เหลือง)</td>
						<td><span id="price-0003425001">xxx</span></td>
					</tr>
