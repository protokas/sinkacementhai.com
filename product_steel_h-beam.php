...
<body id="page-top">
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel h-beam/test1.jpg" alt="">
	</div>
	<br>
	<!-- ตาราง เหล็กเอชบีม (H-BEAM) -->
	<div class="container">
		<div class="datagrid">
		<h4 class="text-center">ตารางเหล็กเอชบีม มาตรฐานเหล็กเอชบีม</h4>
			<br>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>0003312500</td>
						<td>เอสบีม 125x125x6.5 9 มม.</td>
						<td><span id="price-0003312500">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0003315000</td>
						<td>เอสบีม 150x150x7 10 มม.</td>
						<td><span id="price-0003315000">xxx</span></td>
					</tr>

				<tbody>
					<tr>
						<td>0003320000</td>
						<td>เอสบีม 200x200x8 12 มม.</td>
						<td><span id="price-0003320000">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0003325000</td>
						<td>เอสบีม 250x250x9 14 มม.</td>
						<td><span id="price-0003325000">xxx</span></td>
					</tr>
