...
<body id="page-top">
    ...
    <div class="container">
        <h6 class="f700"> <a href="product.php" style="color:black;">สินค้าทั้งหมด</a>/<a href="product_st.php" style="color:black;">สินค้าเหล็ก</a>/<a style="color:gray;">เหล็กเอชบีม (H-BEAM)</a></h6>
    </div>
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <div class=" text-center">
                    <h4 class="br f700" style="color:white" >ราคาเหล็กเอชบีม (H-BEAM)</h4>
                </div>
                    ...
                    <div class="col-md-6">
                        <div id="myCarousel" class="carousel slide" data-ride="carousel" align="center">
                            <div class="carousel-inner">
                                <div class="carousel-item active"> <img src="img/steel/steel h-beam/test1.jpg" class="rounded"> </div>
                                <div class="carousel-item"> <img src="img/steel/steel h-beam/test2.jpg" class="rounded"> </div>
                            </div>
                            <ol class="carousel-indicators list-inline">
                                <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel"> <img src="img/steel/steel h-beam/test1.jpg" class="img-fluid rounded"> </a> </li>
                                <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel"> <img src="img/steel/steel h-beam/test2.jpg" class="img-fluid rounded"> </a> </li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div id="accordion" class="py-5 kanit">
                    <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="card-header p-0 border-0 f100" id="heading-238">
                            <button class="kanit btn btn-link accordion-title border-0 collapsed" data-toggle="collapse" data-target="#collapse-238" aria-expanded="false" aria-controls="#collapse-238"><i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>เหล็กเอสบีม 125x125 </button>
                        </div>
                        <div id="collapse-238" class="collapse show" aria-labelledby="heading-238" data-parent="#accordion">
                            <div class="text-center kanit card-body accordion-body">
                                <p> เอสบีม 125x125x6.5 9 มม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003312500">xxx</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="card-header p-0 border-0 f100" id="heading-239">
                            <button class="kanit btn btn-link accordion-title border-0 collapse" data-toggle="collapse" data-target="#collapse-239" aria-expanded="true" aria-controls="#collapse-239"><i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>เหล็กเอสบีม 150x150 </button>
                        </div>
                        <div id="collapse-239" class="collapse" aria-labelledby="heading-239" data-parent="#accordion">
                            <div class="card-body accordion-body">
                                <p> เอสบีม 150x150x7 10 มม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003315000">xxx</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="card-header p-0 border-0 f100" id="heading-245">
                            <button class="kanit btn btn-link accordion-title border-0 collapsed" data-toggle="collapse" data-target="#collapse-245" aria-expanded="false" aria-controls="#collapse-245"><i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>เหล็กเอสบีม 200x200 </button>
                        </div>
                        <div id="collapse-245" class="collapse " aria-labelledby="heading-245" data-parent="#accordion">
                            <div class="card-body accordion-body">
                                <p> เอสบีม 200x200x8 12 มม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003320000">xxx</span></p>
                            </div>
                        </div>
                    </div>
                    <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="card-header p-0 border-0 f100" id="heading-244">
                            <button class="kanit btn btn-link accordion-title border-0 collapsed" data-toggle="collapse" data-target="#collapse-244" aria-expanded="false" aria-controls="#collapse-244"><i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>เหล็กเอสบีม 250x250 </button>
                        </div>
                        <div id="collapse-244" class="collapse " aria-labelledby="heading-244" data-parent="#accordion">
                            <div class="card-body accordion-body">
                                <p> เอสบีม 250x250x9 14 มม.&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003325000">xxx</span></p>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        var uri = 'http://mv.co.th/WebApi/api/PriceList/GetPriceByGroupID/7';
