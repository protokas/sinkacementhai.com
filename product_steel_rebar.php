...
<body id="page-top">	
	...
	<div class="container text-center">
		<img class=" mx-auto d-block " style="width:60%" src="img/steel/steel rebar/test1.jpg" alt="">
	</div>
	<br>

	<!-- ตาราง เหล็กเส้นข้ออ้อย -->
	<div class="container">
		<div class="datagrid">
			<h4 class="text-center">ตารางเหล็กเส้นข้ออ้อย มาตรฐานเหล็กเส้นข้ออ้อย</h4>
			<br>
			...
			<table class="table table-bordered">
				...
				<tbody>
					<tr>
						<td>0001012900</td>
						<td>ข้ออ้อย 12 มม.SD-40 SCGX10ม.(พับ)</td>
						<td><span id="price-0001012900">xxx</span></td>
					</tr>

					<tr class="alt">
						<td>0001016900</td>
						<td>ข้ออ้อย 16 มม.SD-40 SCGX10ม.(พับ)</td>
						<td><span id="price-0001016900">xxx</span></td>
					</tr>

				<tbody>
					<tr>
						<td>0001020900</td>
						<td>ข้ออ้อย 20 มม.SD-40 SCGX10ม.(พับ)</td>
						<td><span id="price-0001020900">xxx</span></td>
					</tr>
