...
<body id="page-top">
    ...
    <div class="container">
        <h6 class="f700"> <a href="product.php" style="color:black;">สินค้าทั้งหมด</a>/<a href="product_st.php" style="color:black;">สินค้าเหล็ก</a>/<a style="color:gray;">เหล็กแบนรีด</a></h6>
        <br>
        ...
        <div class="row">
            <div class="col">
                ...
                <div class=" text-center">
                    <h4 class="br f700" style="color:white" >ราคาเหล็กแบนรีด</h4>
                </div>
                    ...
                    <div class="col-md-6">
                        <div id="myCarousel" class="carousel slide" data-ride="carousel" align="center">
                            <div class="carousel-inner">
                                <div class="carousel-item active"> <img src="img/steel//steel flat bar/test1.jpg" class="rounded"> </div>
                                <div class="carousel-item"> <img src="img/steel//steel flat bar/test2.jpg" class="rounded"> </div>
                            </div>
                            <ol class="carousel-indicators list-inline">
                                <li class="list-inline-item active"> <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel"> <img src="img/steel//steel flat bar/test1.jpg" class="img-fluid rounded"> </a> </li>
                                <li class="list-inline-item"> <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel"> <img src="img/steel//steel flat bar/test2.jpg" class="img-fluid rounded"> </a> </li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div id="accordion" class="py-5 kanit">
                    <div class="card border-0 wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="card-header p-0 border-0 f100" id="heading-238">
                            <button class="kanit btn btn-link accordion-title border-0 collapsed" data-toggle="collapse" data-target="#collapse-238" aria-expanded="false" aria-controls="#collapse-238"><i class="fas fa-minus text-center d-flex align-items-center justify-content-center h-100"></i>เหล็กแบนรีด </button>
                        </div>
                        <div id="collapse-238" class="collapse show" aria-labelledby="heading-238" data-parent="#accordion">
                            <div class="text-center kanit card-body accordion-body">
                                <p> แบนรีด 1/2 X 1/8 (รีดร้อน) แดง (1.5)&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003700100">xxx</span></p>
                                <p> แบนรีด 1/2 X 3/16 เหลือง (2+/-)&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003700203">xxx</span></p>
                                <p> แบนรีด 5/8 X 1/8 ขาว&nbsp&nbsp&nbsp&nbsp&nbspราคา <span id="price-0003700307">xxx</span></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        var uri = 'http://mv.co.th/WebApi/api/PriceList/GetPriceByGroupID/10';
